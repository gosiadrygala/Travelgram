package com.example.travelgram.Controller;
...
public class SwipeController extends ItemTouchHelper.Callback {
                ...
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    if (buttonsActions != null && buttonInstance != null && buttonInstance.contains(event.getX(), event.getY())) {
                        if (buttonShowedState == ButtonsState.RIGHT_VISIBLE) {
                            ...
                            TextView view = viewHolder.itemView.findViewById(R.id.commentID);
                            buttonsActions.onRightClicked(view.getText().toString());
                        }
                    }
    ...
    public void onDraw(Canvas c, String username) {
        if (currentItemViewHolder != null) {
            TextView author = currentItemViewHolder.itemView.findViewById(R.id.commentAuthor);
            if(author.getText().toString().equals(username)) {
                drawButtons(c, currentItemViewHolder);
            }else buttonShowedState = ButtonsState.GONE;

            System.out.println(author.getText().toString() +" "+ username);
        }
    }
